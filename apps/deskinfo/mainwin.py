...
class AppMainWindow(gtk.Window):
    ...
    def __init__(self, parent=None):
        ...
        self.set_title("Community Linux Shutdown Prompt");
        ...
        self.lab = gtk.Label("Power button pressed. ")		
        ...
        butt3 = gtk.Button("   _Set root Pass   ")
        butt3.show(); butt3.set_use_underline(True)
        butt3.connect("clicked", cance)
        table.attach(butt3,
            # X direction           Y direction
            5, 6,                   2, 3,
            #gtk.EXPAND | gtk.FILL,  gtk.EXPAND | gtk.FILL,
